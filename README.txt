...
1. Obtain product LICENSE KEY from here: https://buy.stripe.com/28oaFBeCPd2n7Be7ss
...
2. Return to DCS and hit the "[" key. You will hear a start beep, The program is now running.
3. Go to the F10 map and hover your cursor where you want the waypoint (ensure the coords are not obscured in the top-left)
4. Hit "spacebar". you'll hear 2 beeps in quick succession. Signaling the program has started and saved the screenshot.
...
6. When ready, hit "spacebar", you'll hear a long deeper toned beep. Wait for the waypoint to be entered.
